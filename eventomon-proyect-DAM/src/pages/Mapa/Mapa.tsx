      ...
      <IonContent className={styles.content} scrollY={false}>
        ...
        <div className={styles.header}>
          <div className={styles.headerInfo}>
            <p className={styles.headerLabel}>EVENTS</p>
            <h2 className={styles.headerTitle}>Near you</h2>
          </div>
          ...
          <>
            ...
            <div className={styles.mapContainer}>
              ...
              >
                ...
                />
                {coordinates && (
                  <CenterMap lat={coordinates.lat} lng={coordinates.lng} />
                )}
                {coordinates && (
                  <Marker
            ...
            <div className={styles.panel}>
              ...
              <p className={styles.panelTitle}>{events.length} EVENTS NEAR</p>
                ...
                {events.map((event) => (
                  ...
                  >
                    ...
                    <div className={styles.miniCardOverlay}>
                      <span className={styles.miniCardTag}>
                        {event.category.toUpperCase()}
                      </span>
                      <h3 className={styles.miniCardTitle}>{event.title}</h3>
                      <p className={styles.miniCardInfo}>
              ...
              {activeEvent && (
                <p
                  ...
                  onClick={() => history.push(`/app/event/${activeEvent.id}`)}
                >
                  Active pin:{" "}
                  <span className={styles.activePinName}>
                    {activeEvent.title}
                  </span>
                </p>
              )}
